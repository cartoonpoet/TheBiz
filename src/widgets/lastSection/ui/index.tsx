...
const LastSection = forwardRef<HTMLDivElement, Props>(({scrollToSection}: Props, ref) => {
        return (
            <div className={style.wrapper} ref={ref}>
                ...
                <div className={style.btn}><Button disabled={false} inlineStyle={{backgroundColor: 'transparent'}}>button</Button></div>
            </div>
        )
    }
);
